...
/**
 * Purpose: This class implements a command to show the turtle so that it can be seen.
 * Assumption: Args passed to the constructor should be empty
 * Dependencies: List
 *
 * Example: If the user inputs the command "st", then create an instance of this class and
 * run the command.
 *
