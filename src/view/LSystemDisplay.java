 ...
 * on a backend LSystemsModel to do the work that is needed for the view elements to act as they should.
 * Assumptions: The LSystemDisplay relies on many other classes to work properly, so the assumption is
 * that these other classes will be working properly and will be thoroughly tested to make it easy
 * to find any bug.
 * Dependencies: LSystemsModel, PropertiesLoader
 *
