...
/**
 * Purpose: This class hides away some complexity of creating a UI element to allow a user to
 * choose the color of a certain element in the UI.
 * Dependencies: Node, ColorPicker, VBox, Color, Text
